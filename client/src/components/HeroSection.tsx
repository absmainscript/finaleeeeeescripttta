    ...
    >
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-stretch min-h-[calc(110vh-80px)] pt-24 lg:pt-32 pb-20">
            {/* Conteúdo textual */}
            <motion.div
            ...
            >
              <div className="relative h-full flex items-center">
                {/* Container principal da foto com glassmorphism elegante - altura fixa no desktop */}
                <div className="relative bg-white/40 backdrop-blur-xl border border-white/30 rounded-3xl p-4 sm:p-8 shadow-2xl shadow-purple-200/20 h-full min-h-[28rem] lg:min-h-[26rem] flex items-center">
